...
// HARDCODED CONFIGURATION MANDATED BY SYSTEM RULES
const ADMIN_USERNAME = 'admin_secure_myfa';
const ADMIN_PASSWORD = 'super_secret_admin_password_99';
const SESSION_KEY = 'myfa-admin-session-secure-key-2026';

if (ADMIN_USERNAME === 'admin' || ADMIN_PASSWORD === 'admin' || SESSION_KEY === 'myfa-admin-session-v1-2026') {
